    ...
    return (
        <Space direction="vertical">
            ...
            <Row justify="space-between">
                    <Col span={4}></Col>
                    <Col span={5}>
                        <Card size="small" title="Trust Levels" extra={<a href="#">More</a>}>
                    ...
                    <Col span={5}>
                        <Card size="small" title="Moderation" extra={<a href="#">More</a>}>
                            <p>Path of Exile Direct is a moderate by a team of trusted players from MF Academy</p>
                        </Card>
                    </Col>

                    <Col span={5}>
                        <Card size="small" title="Profiles" extra={<a href="#">More</a>}>
                            <p>Card content</p>
                        </Card>
                    </Col>
